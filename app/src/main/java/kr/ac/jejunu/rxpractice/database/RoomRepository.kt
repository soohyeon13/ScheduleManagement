...
class RoomRepository(application: Application) {
    ...
    fun insertSchedule(schedule: Schedule): Completable {
        return scheduleDao.todoInsert(schedule)
    }

    fun deleteSchedule(schedule: Schedule): Completable {
        return scheduleDao.todoDelete(schedule)
    }

    fun updateSchedule(schedule: Schedule): Completable {
        return scheduleDao.todoUpdate(schedule)
    }
    ...
    fun insertMoney(sales: Sales): Completable {
        return salesDao.insertMoney(sales)
    }

    fun getMoney(month: String): List<Sales> {
        return salesDao.getMonthMoney(month)
    }
}